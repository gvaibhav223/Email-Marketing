  ...
  return (
    <div className=" container ">
      <div className="content-page">
        Terms and Conditions Welcome to Website Name! These terms and conditions
        outline the rules and regulations for the use of Company Name's Website,
        located at Website.com. By accessing this website we assume you accept
        these terms and conditions. Do not continue to use Website Name if you
        ...
        not: Republish material from Website Name Sell, rent or sub-license
        material from Website Name Reproduce, duplicate or copy material from
        Website Name Redistribute content from Website Name This Agreement shall
        begin on the date hereof. Parts of this website offer an opportunity for
        users to post and exchange opinions and information in certain areas of
        the website. Company Name does not filter, edit, publish or review
        ...
        views and opinions. To the extent permitted by applicable laws, Company
        Name shall not be liable for the Comments or for any liability, damages
        ...
        unlawful activity. You hereby grant Company Name a non-exclusive license
        ...
        engines; News organizations; Online directory distributors may link to
        our Website in the same manner as they hyperlink to the Websites of
        ...
        the hyperlink compensates the absence of Company Name; and (d) the link
        ...
        to our website, you must inform us by sending an e-mail to Company Name.
        ...
        party's site. No use of Company Name's logo or other artwork will be
...
// ref link : https://www.termsandconditionsgenerator.com/
