  ...
  return (
    <div className=" container ">
      <div className="content-page">
        ...
        Website.com, one of our main priorities is the privacy of our visitors.
        This Privacy Policy document contains types of information that is
        collected and recorded by Website Name and how we use it. If you have
        ...
        address, and telephone number. How we use your information We use the
        ...
        and prevent fraud Log Files Website Name follows a standard procedure of
        ...
        information. Cookies and Web Beacons Like any other website, Website
        Name uses ‘cookies'. These cookies are used to store information
        ...
        browser type and/or other information. DoubleClick DART Cookie Google is
        one of a third-party vendor on our site. It also uses cookies, known as
        DART cookies, to serve ads to our site visitors based upon their visit
        to www.website.com and other sites on the internet. However, visitors
        may choose to decline the use of DART cookies by visiting the Google ad
        ...
        for each of the advertising partners of Website Name. Third-party ad
        ...
        that appear on Website Name, which are sent directly to users' browser.
        ...
        Third-Party Privacy Policies Website Name's Privacy Policy does not
        ...
        guide their online activity. Website Name does not knowingly collect any
...
// Ref link : https://www.privacypolicygenerator.info/
